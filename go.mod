...
require (
	github.com/applegreengrape/finnhub-terminal/finnhub v0.0.0-20201026011118-28077744f0d2
	github.com/applegreengrape/finnhub-terminal/widgets v0.0.0-20201026011450-98c96d4e8f02
